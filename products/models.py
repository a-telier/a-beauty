...
class Product(models.Model):
    ...
    image = models.FileField(default="", null=True, blank=True, upload_to='products/products')
    additionalImages = models.FileField(default="", null=True, blank=True, upload_to='products/additional')
